...
/* Exported types ------------------------------------------------------------*/
extern AUDIO_DrvTypeDef PCM1774_drv;
...
static DrvContextTypeDef pcm1774;
...
HAL_StatusTypeDef I2C1_Init(void)
{
	...
	if(HAL_I2C_GetState(&I2C_1) == HAL_I2C_STATE_RESET)
	{
		I2C_1.Init.ClockSpeed = I2C1_SPEED;
		I2C_1.Init.DutyCycle = I2C_DUTYCYCLE_2;
		I2C_1.Init.OwnAddress1 = 0x33;
		...
		I2C_1.Init.NoStretchMode = I2C_NOSTRETCH_ENABLE;
		I2C_1.Instance = I2C1;
		/* Init the I2C */
		I2C1_MspInit();
		return HAL_I2C_Init(&I2C_1);
	}
...
void I2C1_MspInit(void)
{
  ...
  /* Enable and set I2C1 Interrupt to the highest priority */
...
uint8_t BSP_AUDIO_OUT_Init(void **handle, uint16_t OutputDevice, uint8_t Volume, uint32_t AudioFreq)
{
  ...
  BSP_PCM1774_CODEC_Init(handle, Volume, AudioFreq);
...
static DrvStatusTypeDef BSP_PCM1774_CODEC_Init( void **handle, uint8_t Volume, uint32_t AudioFreq)
{
  ...
  if(pcm1774.isInitialized == 1)
  {
    // We have reached the max num of instance for this component /
    return COMPONENT_ERROR;
  }

  if (I2C1_Init() == COMPONENT_ERROR )
  {
    return COMPONENT_ERROR;
  }
  ...
  // Setup handle. /
  pcm1774.who_am_i      = 0;
  pcm1774.ifType        = 0; // I2C interface
  pcm1774.address       = PCM1774_CODEC_I2C_ADDRESS_LOW;
  pcm1774.instance      = 0;
  pcm1774.isInitialized = 0;
  pcm1774.isEnabled     = 0;
  pcm1774.isCombo       = 1;
  pcm1774.pData         = ( void * )NULL;
  pcm1774.pVTable       = ( void * )&PCM1774_drv;
  pcm1774.pExtVTable    = 0;
...
uint8_t BSP_AUDIO_OUT_SetVolume(void *handle, uint8_t Volume)
{
  ...
  pcm1774_SetVolume(handle, Volume);
  /*if(ctx == NULL)
  {
    return COMPONENT_ERROR;
  }
...
__weak uint8_t BSP_AUDIO_OUT_ClockConfig(uint32_t AudioFreq, void *Params)
{
  ...
  RCC_PeriphCLKInitStruct.PLLSAIDivQ = 2;
...
static void SAIx_MspInit(void)
{
	...
	if(hsai->Instance == AUDIO_SAIx)
	{
		...
		hdma_saiTx.Instance = DMA2_Stream5;
...
static void SAIx_Init(uint32_t AudioFreq)
{
  ...
  haudio_out_sai.FrameInit.FSDefinition = SAI_FS_STARTFRAME;//SAI_FS_CHANNEL_IDENTIFICATION;
